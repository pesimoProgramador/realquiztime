...
$examen_activado = optional_param('examenActivado', -1, PARAM_INT);
...
$PAGE->set_url('/mod/realquiztime/desactivar_examen.php', array('id' => $cm->id));
...
if (!$alumno) {
    ...
    if ($realquiztime->examen_activado == 1) {
        ?>
        ...
        <script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/realquiztime/js/desactivar_examen.js"></script>
        <?php
        echo '
        <div id="divInterfaz">
            <ul class="ul no">
        ...
        if ($realquiztime->examen_activado == 0) {
            ...
            echo '
            <li class="li"><a class="active" href="desactivar_examen.php?id='; echo json_encode($id); echo'">Desactivar examen</a></li>
            ';
        }
        echo'
        ...
        <h3>El examen esta desactivado</h3>
        ';
    }
}
