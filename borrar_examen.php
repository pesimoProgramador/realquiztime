...
$si = optional_param('si', 0, PARAM_INT);
...
$PAGE->set_url('/mod/realquiztime/borrar_examen.php', array('id' => $cm->id));
...
if ($si == 1) {
    ...
    $row->una_vez_examen_activado = 0;
    $DB->update_record("realquiztime", $row, $bulk=false);

    $realquiztime->examen_activado = 0;
}
...
if (!$alumno) {
    ...
    if ($realquiztime->examen_activado == 0) {
        if ($si == 1) {
            ...
            <script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/realquiztime/js/borrar_examen.js"></script>
            <?php
            echo '
            <div id="divInterfaz">
            <ul class="ul no">
            ...
            echo'
                ...
                <li class="li"><a class="active" href="borrar_examen.php?id='; echo json_encode($id); echo'">Borrar examen</a></li>
            </ul>
            </div>
            ...
            <ul class="ul">
                ...
                <li class="li"><a href="gestionar_grupos.php?id='; echo json_encode($id); echo'">Gestionar grupos</a></li>
                ';
            if ($realquiztime->examen_activa == 0) {
                echo '
                <li class="li"><a href="activar_examen.php?id='; echo json_encode($id); echo'">Activar examen</a></li>
                ';
            } else {
