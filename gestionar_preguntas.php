...
$PAGE->set_url('/mod/realquiztime/gestionar_preguntas.php', array('id' => $cm->id));
...
if (!$alumno) {
    ...
    <script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/realquiztime/js/gestionar_preguntas.js"></script>
    ...
    <div id="divInterfaz">
        <div>
        <ul class="ul">
            <li class="li"><a class="active" href="gestionar_preguntas.php?id='; echo json_encode($id); echo'">Gestionar preguntas</a></li>
        ...
        <div>
            <button id="buttonCrearPregunta" onclick="buttonCrearPregunta()" >Crear pregunta</button>
            <button id="buttonBorrarPregunta" onclick="buttonBorrarPregunta()" >Borrar pregunta</button>
        </div>
    </div>
    <script>
